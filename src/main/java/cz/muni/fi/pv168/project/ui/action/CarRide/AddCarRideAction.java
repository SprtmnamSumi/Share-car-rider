...
final class AddCarRideAction extends AbstractAction {
    ...
    AddCarRideAction(JTable carRidesTable, ListModel<Category> categoriestListModel, ListModel<Template> carRideTemplateListModel, TableModel<Template> repository, DefaultActionFactory<Category> categoryActionFactory, CategoryTableModel categoryTableMode) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        var dialog = new CarRideDialog(createPrefilledCarAction(), categoriestListModel, carRideTemplateListModel, repository, categoryActionFactory, categoryTableMode);
