 ...
 */
public class TemplateablePanel extends JPanel {

    private final JTable table;
    private final Consumer<Integer> onSelectionChange;

    public TemplateablePanel(TemplateTableModel carRideTableModel, CategoryListModel categoryListModel, Consumer<Integer> onSelectionChange) {
    ...
    private JTable setUpTable(TemplateTableModel templateTableModel, CategoryListModel departmentListModel) {
