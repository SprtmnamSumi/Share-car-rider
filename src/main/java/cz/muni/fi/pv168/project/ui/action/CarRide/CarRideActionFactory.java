...
public class CarRideActionFactory implements DefaultActionFactory<CarRide> {
    ...
    public CarRideActionFactory(EntityListModelAdapter<Category> categoryListModel, EntityListModelAdapter<Currency> currencyListModel, EntityListModelAdapter<Template> templateListModel, TableModel<Template> repository, DefaultActionFactory<Category> categoryActionFactory, CategoryTableModel categoryTableMode) {
    ...
    public Action getAddAction(JTable table) {
        return new AddCarRideAction(table, categoryListModel, currencyListModel, templateListModel, repository, categoryActionFactory, categoryTableMode);
    }
    ...
    public Action getEditAction(JTable table) {
        return new EditCarRideAction(table, categoryListModel, currencyListModel, templateListModel, repository, categoryActionFactory, categoryTableMode);
    }
}
