...
public class CarRideTablePanel extends JPanel {
    ...
    public CarRideTablePanel(CarRideTableModel carRideTableModel, DepartmentListModel departmentListModel, Consumer<Integer> onSelectionChange) {
        setLayout(new BorderLayout());
        table = setUpTable(carRideTableModel, departmentListModel);
    ...
    private JTable setUpTable(CarRideTableModel carRideTableModel, DepartmentListModel departmentListModel) {
